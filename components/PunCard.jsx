...
const PunCard = ({ post, handleTagClick, handleEdit, handleDelete }) => {
  ...
  const handleCopy = () =>{
    setCopied(post.pun)
    navigator.clipboard.writeText(post.pun);
  ...
  return (
    <div className="prompt_card">
      <div className="flex items-start justify-between gap-5">
        <div className="flex justify-start flex-1 gap-3 cursor-pointer item">
          <Image
      ...
      <p className="my-4 text-sm text-gray-700 font-satoshi">{post.pun}</p>
      <p
